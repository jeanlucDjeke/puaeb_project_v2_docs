					...
					<script>
						...
						Ext.onReady(function () {
							...
							/************ Gestion d'un menu ajouté ************/
							var itemByjldjeke = {"iconAlign":"top","scale":"large","tooltip":"Analyse libre","iconCls":"montest","hrefTarget":"_self","href":"javascript:javascript:execDirectUrl('/SpagoBI/servlet/AdapterHTTP?ACTION_NAME=MENU_BEFORE_EXEC&MENU_ID=128', 'MISSIONS IGEN > ANALYSE')","firstUrl":"/SpagoBI/servlet/AdapterHTTP?ACTION_NAME=LOGOUT_ACTION&LIGHT_NAVIGATOR_DISABLED=TRUE&NEW_SESSION=TRUE"};
					    ...
					    itemsM.splice(3,0,menu_carte);
					    itemsM.splice(4,0,menu_cube_olap);
					    itemsM.splice(5,0,menu_evolution_rappro);
					    itemsM.splice(5,0,menu_analyse_libre);
					    itemsM.splice(5,0,menu_exam);
					    itemsM.splice(5,0,menu_tableau_bord);
					 
					    //delete itemsM[1];

					    /*console.log("Les logs Debutent");
					    itemsM.forEach(function(element) {
					    ...
					    for(i=0; i< itemsM.length; i++){
					    	...
					    	if(menuItem.itemLabel != null && (menuItem.itemLabel == "HELP" || menuItem.itemLabel == "INFO")){
								delete 	itemsM[i];
							}

							//Modifier la liste des menus pour afficher le menu power
							if(menuItem.iconCls != null && (menuItem.iconCls == "my_data" || menuItem.iconCls == "repo" || menuItem.iconCls == "charts" || menuItem.iconCls == "flag" )){
								//alert(menuItem.iconCls);
								//alert(itemsM[i].itemLabel);
								delete 	itemsM[i];
							}
